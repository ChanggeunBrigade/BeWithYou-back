...
sender = asyncsender.FluentSender(
    "opencv", host=FLUENT_BIT_HOST, port=FLUENT_BIT_PORT, nanosecond_precision=True, queue_maxsize=1000,
    queue_circular=True
)
...
while True:
    ...
    data = cv2.imencode(".webp", frame, [cv2.IMWRITE_WEBP_QUALITY, 100]).tostring()
